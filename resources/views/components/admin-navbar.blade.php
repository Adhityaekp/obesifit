...
<header class="bg-white navbar-shadow sticky top-0 z-50">
        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center">
                <a href="/admin" class="flex items-center">
                    <div class="w-8 h-8 bg-primary rounded-full flex items-center justify-center mr-2 logo-icon">
                        <i class="fas fa-heartbeat text-white"></i>
                    </div>
                    <span class="text-xl font-bold text-dark">OBESIFIT
                        <span class="text-sm bg-primary text-white px-2 py-1 rounded ml-2">Admin</span>
                    </span>
                </a>
            </div>
            ...
            <div class="hidden md:flex items-center space-x-8">
                <a href="/admin/dashboard" class="nav-link text-dark hover:text-primary font-medium">Dashboard</a>
                <a href="/admin/users" class="nav-link text-dark hover:text-primary font-medium">Manajemen User</a>
                <a href="/articles-videos/create" class="nav-link text-dark hover:text-primary font-medium">Konten</a>
            </div>
            ...
            <div class="hidden md:flex items-center space-x-4">
                    ...
                    <div id="notif-dropdown"
                        ...
                        <div
                            ...
                            <div class="flex justify-between items-center">
                                <span class="font-semibold text-base">Notifikasi Admin</span>
                ...
                <div class="relative" id="user-dropdown">
                    <button id="dropdown-toggle"
                        ...
                        <div
                            class="w-10 h-10 bg-primary rounded-full overflow-hidden border-2 border-primary profile-avatar flex items-center justify-center">
                            <i class="fas fa-user-shield text-white text-lg"></i>
                        </div>
                        <span class="text-dark font-medium hidden lg:inline-block">Admin</span>
                    ...
                    <div id="dropdown-menu"
                        ...
                        <div class="px-4 py-3 border-b border-gray-100">
                            <p class="text-sm font-semibold text-dark">Administrator</p>
                            <p class="text-xs text-gray-500 truncate">admin@obesifit.com</p>
                        </div>

                        <a href="#" onclick="openPasswordModal()"
                            class="flex items-center px-4 py-3 text-gray-700 hover:bg-gray-50 transition">
                            <i class="fas fa-key mr-3 text-primary w-5"></i>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-gray-100">
        <div class="container mx-auto px-4 py-4">
            <div class="flex flex-col space-y-3">
                ...
                <a href="/admin/users"
                    class="text-dark hover:text-primary hover:bg-gray-50 font-medium px-4 py-3 rounded-lg transition">
                    <i class="fas fa-users mr-3 text-primary w-5"></i>Manajemen User
                </a>
                <a href="/articles-videos/create"
                    class="text-dark hover:text-primary hover:bg-gray-50 font-medium px-4 py-3 rounded-lg transition">
                    <i class="fas fa-file-alt mr-3 text-primary w-5"></i>Konten
                </a>
                ...
                <div class="pt-4 border-t border-gray-200">
                    <div class="mobile-user-card">
                        <div class="flex items-center space-x-3 mb-4">
                            <div
                                class="w-14 h-14 bg-primary rounded-full overflow-hidden border-2 border-primary flex items-center justify-center">
                                <i class="fas fa-user-shield text-white text-xl"></i>
                            </div>
                            <div class="flex-1 min-w-0">
                                <p class="font-semibold text-dark truncate">Administrator</p>
                                <p class="text-sm text-gray-500 truncate">admin@obesifit.com</p>
                            </div>
                        </div>
    ...
    <div id="changePasswordModal"
        ...
        <div class="bg-white w-full max-w-md rounded-2xl shadow-2xl modal-content">
            ...
            <form id="changePasswordForm" class="p-6 space-y-4">
                ...
                <div>
                    <label for="current_password" class="block text-sm font-medium text-gray-700 mb-1">Kata Sandi Saat
                        Ini</label>
                    <div class="relative">
                    ...
                    <span class="text-red-500 text-xs error-message" id="current_password_error"></span>
                </div>
                ...
                <div>
                    ...
                    <span class="text-red-500 text-xs error-message" id="new_password_error"></span>
                </div>
                ...
                <div>
                    ...
                    <span class="text-red-500 text-xs error-message" id="new_password_confirmation_error"></span>
                </div>
    ...
    <div id="notif-modal"
        ...
        <div class="bg-white w-full max-w-md rounded-2xl shadow-2xl modal-content">
            <div class="bg-gradient-to-r from-primary to-secondary text-white p-5 rounded-t-2xl">
                <div class="flex items-center justify-between">
                    <h2 class="text-lg font-bold">Semua Notifikasi Admin</h2>
